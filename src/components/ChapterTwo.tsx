  ...
  return (
    <section ref={chapterTwoRef} className="py-6 sm:py-8 lg:py-12 xl:py-20 section-connector organic-bg">
      <div className={`max-w-7xl mx-auto w-full transition-all duration-1000 ${chapterTwoVisible ? 'story-reveal' : 'opacity-0 translate-y-10'}`}>
        {/* Chapter Header - Centered to match Chapter One */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 overflow-visible">
          {[
            ...
            <div
              key={step.title}
              className="story-chapter content-flow p-3 sm:p-4 lg:p-6 rounded-2xl text-center hover-lift min-h-[160px] sm:min-h-[180px] lg:min-h-[220px] xl:min-h-[300px] flex flex-col justify-center section-transition shadow-lg"
            >
